...
public class DeleteFdnContactScreen extends Activity {
    ...
    private void displayProgress(boolean flag) {
        // Window.setFeatureInt/PROGRESS_VISIBILITY_* (barra de progresso na barra de
        // título) foi removido do SDK moderno. Sem substituto direto de "progress na
        // titlebar" — quem quiser indicação visual de progresso usa um ProgressBar
        // normal no layout. Aqui vira só um no-op seguro.
    }
