...
public class ADNList extends ListActivity {
    ...
    private void displayProgress(boolean flag) {
        ...
        // Window.setFeatureInt/PROGRESS_VISIBILITY_* removido do SDK moderno — sem
        // substituto direto. O texto acima já indica "carregando" pro usuário, então
        // a perda é só cosmética (sem barra de progresso na titlebar).
    }
