...
public class EditFdnContactScreen extends Activity {
    ...
    /** projection for phone number query (android.provider.Contacts -> ContactsContract,
     *  mesmo padrão usado em EditPhoneNumberPreference/BluetoothAtPhonebook) */
    ...
    static {
        ...
        CONTACT_IMPORT_INTENT.setType(ContactsContract.CommonDataKinds.Phone.CONTENT_ITEM_TYPE);
    }
    ...
    private void displayProgress(boolean flag) {
        ...
        mDataBusy = flag;
        // Window.setFeatureInt/PROGRESS_VISIBILITY_* foram removidos do SDK moderno
        // (mesmo achado de DeleteFdnContactScreen/ADNList) -> vira no-op; o indicador
        // visual de progresso da tela de chamada não depende disso.
