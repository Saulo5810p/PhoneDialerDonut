...
public class Ringer {
    ...
    void ring() {
        ...
        synchronized (this) {
            // mHardwareService.setAttentionLight() (LED de notificação) era API
            // interna, sem substituto público direto — removido. Toque/vibração
            // continuam funcionando normalmente abaixo.
    ...
    void stopRing() {
        synchronized (this) {
            ...
            // mHardwareService.setAttentionLight() removido, mesmo motivo do ring().
