 ...
 *
 * ============================================================================
 * ADAPTADO — habilitar/desabilitar FDN (IccCard.setIccFdnEnabled/
 * getIccFdnEnabled) é signature-only, sem equivalente público -- mesma parede
 * de EnableIccPinScreen. Layout mantido; botão mostra a mensagem de "não faço
 * milagre". Como não dá mais pra consultar o estado real do FDN, o título
 * sempre mostra "Enable".
 * ============================================================================
 */
...
public class EnableFdnScreen extends Activity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        setTitle(getResources().getText(R.string.enable_fdn));
    }
    ...
    private View.OnClickListener mClicked = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            // Habilitar/desabilitar FDN exige API interna signature-only
            // -- ver nota no topo do arquivo.
            NotPortedYet.show(EnableFdnScreen.this);
        }
    };
}
