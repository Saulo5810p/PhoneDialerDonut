...
public class EditPhoneNumberPreference extends EditTextPreference {
    ...
    public EditPhoneNumberPreference(Context context, AttributeSet attrs) {
        ...
        // android.provider.Contacts (API descontinuada) -> ContactsContract (mesmo padrão
        // usado em SimContacts/BluetoothAtPhonebook/EditFdnContactScreen)
        mContactListIntent.setType(ContactsContract.CommonDataKinds.Phone.CONTENT_ITEM_TYPE);
