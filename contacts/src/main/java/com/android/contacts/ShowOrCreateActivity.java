...
public final class ShowOrCreateActivity extends Activity {
    ...
    // Antes: Phones.PERSON_ID (tabela unificada antiga). Agora: PhoneLookup._ID já
    // devolve o contact id diretamente na consulta de PhoneLookup.CONTENT_FILTER_URI.
    ...
    // QUERY_KIND_EMAIL_OR_IM removido: usava ContactMethodsColumns (API antiga) e já
    // não era mais referenciado em lugar nenhum após a migração da busca por email.
    ...
    protected void onCreate(Bundle icicle) {
        ...
        if (SCHEME_MAILTO.equals(scheme)) {
            ...
            // People.WITH_EMAIL_OR_IM_FILTER_URI (API antiga, buscava email OU IM juntos)
            // não tem equivalente único no ContactsContract; aqui buscamos por email,
            // que cobre o caso de uso principal (mailto:) desta activity.
            ...
            mQueryHandler.startQuery(QUERY_TOKEN, null,
                    Uri.withAppendedPath(PhoneLookup.CONTENT_FILTER_URI, ssp),
