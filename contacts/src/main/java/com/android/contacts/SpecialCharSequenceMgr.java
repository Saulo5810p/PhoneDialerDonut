...
public class SpecialCharSequenceMgr {
    ...
    static boolean handlePinEntry(Context context, String input) {
        if ((input.startsWith("**04") || input.startsWith("**05")) && input.endsWith("#")) {
            // Antes: chamava ITelephony (interno, IPC direto com o processo do sistema).
            // Agora: TelephonyCompat usa TelecomManager#handleMmi, público a partir da
            // API 26; abaixo disso não há equivalente e o método devolve false.
            return TelephonyCompat.handlePinMmi(context, input);
        }
        return false;
    }
